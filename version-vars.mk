...
CONTAINER_IBM_ART_VERSION = 1.10.*
CONTAINER_MLFLOW_VERSION = 1.*
CONTAINER_PREFECT_VERSION = 1.2.*
CONTAINER_PYTHON_VERSION = 3.9.*
CONTAINER_PYTORCH_CUDA_VERSION = cu113
CONTAINER_PYTORCH_MAJOR_MINOR_VERSION = 1.11
CONTAINER_PYTORCH_TORCHAUDIO_VERSION = 0.11.0
CONTAINER_PYTORCH_TORCHVISION_VERSION = 0.12.0
CONTAINER_PYTORCH_VERSION = $(CONTAINER_PYTORCH_MAJOR_MINOR_VERSION).0
